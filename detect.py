...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # Apply NMS
        pred, temp_prediction = non_max_suppression(pred, first_frame, temp_prediction,  opt.conf_thres, opt.iou_thres, classes=opt.classes, agnostic=opt.agnostic_nms)
        first_frame = False
        # return a list contains six numbers. [x1, y1, x2, y2, probablity, class]
...
if __name__ == '__main__':
    ...
    # /mnt/disk1/pengyingqi/yolov5/runs/train/edit_tracing/weights/best.pt
    ...
    parser.add_argument('--source', type=str, default='/mnt/disk1/pengyingqi/test/wg2022_ir_049_split_02/*', help='source')  # file/folder, 0 for webcam
...
# @torch.no_grad()
# def run(weights='/mnt/disk1/pengyingqi/yolov5/runs/train/exp4/weights/best.pt',  # model.pt path(s)
#         source='/mnt/disk1/pengyingqi/test/02_6321_0274-2773',  # file/dir/URL/glob, 0 for webcam
...
# def parse_opt():
#     parser = argparse.ArgumentParser()
#     parser.add_argument('--weights', nargs='+', type=str, default='/mnt/disk1/pengyingqi/yolov5/runs/train/exp4/weights/best.pt', help='model.pt path(s)')
#     parser.add_argument('--source', type=str, default='/mnt/disk1/pengyingqi/test/02_6321_0274-2773', help='file/dir/URL/glob, 0 for webcam')
